...
class ApiTest extends TestCase
{
    ...
    /**
     * test for Fire Ice Controller Getting All books
     */
    public function testGettingAllFireIceBooks()
    {
    ...
    /**
     * test for Fire Ice Controller Getting a single books
     */
    public function testGetSingleFireIceBook()
    {
    ...
    /**
     *
     * TEST for Book Controller create a new book
     */
    ...
    /**
     *
     * TEST for Book Controller update a new book
     */
...
//        dd($book);
        ...
        $response->assertStatus(200);
        $response->assertJson(['data' =>"The book $name was updated successfully"]);
        $response->assertJson(["status" => "success"]);
    }
...
//        dd(json_decode($response->getContent(), true));
    ...
    /**
     * test for Book Controller Getting All books
     */
